...
from elm_model import *      
    ...
    # parameters 
nume='vr_train_liniste_rostire_set' # Database (Matlab format - similar to what is supported by the LIBSVM library)
#nume='mnist' # MNIST dataset 
nr_neuroni=50 # Proposed number of neurons on the hidden layer 
...
print(inW)
print(outW)
sio.savemat("elm_continuu_weights.mat",input_output_weights)
